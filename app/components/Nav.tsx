  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="#journey" style={{ color: "var(--ink-muted)", textDecoration: "none", whiteSpace: "nowrap" }}>
          The journey
        </a>
        <a href="#ndis" style={{ color: "var(--ink-muted)", textDecoration: "none", whiteSpace: "nowrap" }}>
          NDIS
        </a>
        <a href="#stories" style={{ color: "var(--ink-muted)", textDecoration: "none", whiteSpace: "nowrap" }}>
          Stories
        </a>
        <a href="#contact" style={{ color: "var(--ink-muted)", textDecoration: "none", whiteSpace: "nowrap" }}>
          Contact
        </a>
      </div>
