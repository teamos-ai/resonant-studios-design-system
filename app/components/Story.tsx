// readability-exempt: contains a verbatim participant testimonial which we never edit for grade level.
export default function Story() {
  return (
    <section id="stories" style={{ background: "var(--bg-sunken)", padding: "96px 40px" }}>
      <div
        className="grid-2"
        style={{
          maxWidth: 1040,
      ...
      >
        ...
        <div>
          ...
          >
            &ldquo;The first time I heard my voice come back through the speakers, properly recorded — I just sat there.
            It felt like something I&rsquo;d made, not something that had been made for me.&rdquo;
          </div>
          <div style={{ marginTop: 20, fontSize: 14, color: "var(--ink-muted)" }}>
            <span style={{ fontWeight: 600, color: "var(--ink)" }}>Sam</span> · 8 sessions · finished his first single,{" "}
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 14, fontStyle: "italic" }}>
