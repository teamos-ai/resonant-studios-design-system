      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              We acknowledge the Traditional Custodians of the land on which we work, and pay our respects to Elders
              past and present.
            </div>
          </div>
          {columns.map(([h, items]) => (
            <div key={h}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 14 }}>
                {items.map((x) => (
                  <a key={x} href="#" style={{ color: "var(--ink-muted)", textDecoration: "none" }}>
                    {x}
                  </a>
                ))}
              </div>
        ...
        >
          <span>© {new Date().getFullYear()} Resonant Studios</span>
